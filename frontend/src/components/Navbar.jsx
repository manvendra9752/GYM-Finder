...
function Navbar() {
  ...
  return (
    <nav
      className="bg-slate-800 border-b border-gray-200 container sm:max-w-screen-2xl mx-auto px-8  mb-
    20"
    >
      <div className="container mx-auto px-4 py-2 flex justify-between items-center">
        ...
        >
          ...
          {authUser ? (
            ...
            <Link to="/login">
              <button className="bg-slate-800 w-full text-white px-4 py-2 rounded-md hover:bg-slate-900 z-10">
                Login
              </button>
            </Link>
          )}
      ...
      <div className="md:hidden hidden" id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          {authUser ? (
            ...
            <Link to="/login">
              <button className="bg-slate-900 text-white px-4 py-2 rounded-md hover:bg-slate-600">
                Login
              </button>
            </Link>
          )}
