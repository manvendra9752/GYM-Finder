...
function Login() {
  ...
  return (
    <section className="md:min-h-screen h-full flex items-center justify-center  py-12">
      <div className="flex flex-col justify-around md:flex-row items-center  shadow-lg rounded-lg overflow-hidden">
        <div className="md:w-1/2 w-full p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              className="w-full bg-slate-600 text-white py-2 rounded-lg hover:bg-slate-700 transition duration-200"
            >
              Log in
            </button>
