...
function Signup() {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center  shadow-lg rounded-lg overflow-hidden justify-around ">
        <div className="md:w-1/2 w-full p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
              <label htmlFor="insta" className="block text-gray-700 mb-2">
                Instagram
              </label>
              <input
                placeholder="url"
